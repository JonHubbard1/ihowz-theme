<?php
/**
 * Template Name: Full width with Image, Widgets and Title
 * Template Post Type: page
 *
 * A full-width template with a featured image, page title header and a widget sidebar.
...
<main class="site-main site-main-fullwidth">
    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        <?php if (has_post_thumbnail()) : ?>
            <div class="page-featured-image-fullwidth">
                <?php the_post_thumbnail('full', array('class' => 'page-featured-image', 'alt' => get_the_title())); ?>
            </div>
        <?php endif; ?>
