...
### Changed
- **News page featured image height** — post card and post thumbnail images are now capped at `min(512px, 40vh)` instead of a fixed `200px`, improving appearance on larger viewports without distorting images.
